...
public class CumulativeMapperByCountry extends Mapper<Object, Text, Text, CumulativeWritable>{
    ...
    public void map(Object key, Text val, Context context) throws IOException, InterruptedException{
        ...
        String date = tokens[0], location = tokens[1];
        if(!location.contains("_")) {
            ...
            date_area.set(date + "," + countryName);
